...
export function connectSocket(): Socket {
  ...
  if (import.meta.env.DEV) {
    // Sólo log de errores en dev — info de connect/disconnect es ruido cuando
    // el HMR reconecta varias veces. Si necesitas trazas más finas, usa el panel
    // de Network en devtools.
